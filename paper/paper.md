...
* `libpysal` [@libpysal-2026] provides spatial weights, data structures, and foundational utilities
* `esda` [@esda-2026] supports exploratory spatial data analysis
* `spreg` [@spreg-2026] implements spatial econometric models
* `mapclassify` [@mapclassify-2025] provides classification schemes for choropleth mapping
